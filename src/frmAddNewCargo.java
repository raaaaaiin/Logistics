...
public class frmAddNewCargo extends javax.swing.JFrame {
    Connection con = null;
    PreparedStatement pst = null;

    public frmAddNewCargo() {
        initComponents();
    ...
    private void initComponents() {
        ...
        typeofcargo = new javax.swing.JTextField();
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                        ...
                        .addComponent(saddress, javax.swing.GroupLayout.PREFERRED_SIZE, 251, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(21, 21, 21))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(sname)
                            .addComponent(sphone)
                            .addComponent(semail, javax.swing.GroupLayout.DEFAULT_SIZE, 269, Short.MAX_VALUE))
                        .addContainerGap())))
        );
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(rname)
                            .addComponent(remail)
                            .addComponent(rphone, javax.swing.GroupLayout.Alignment.TRAILING)))
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        .addComponent(jLabel11)
                        .addGap(50, 50, 50)
                        .addComponent(raddress, javax.swing.GroupLayout.DEFAULT_SIZE, 234, Short.MAX_VALUE)))
                .addContainerGap())
        );
        ...
        jLabel12.setText("Cargo Info:");

        jLabel13.setText("Tracking No:");

        jLabel14.setText("Type of Cargo:");

        jLabel15.setText("Weight:");

        jLabel17.setText("Dept Time:");
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(trackingno)
                            .addComponent(weight)
                            .addComponent(depttime, javax.swing.GroupLayout.DEFAULT_SIZE, 219, Short.MAX_VALUE)
                            .addComponent(typeofcargo))
                        .addGap(81, 81, 81)
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(comments, javax.swing.GroupLayout.DEFAULT_SIZE, 244, Short.MAX_VALUE)
                            .addComponent(origin)
        ...
        jPanel6Layout.setVerticalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel13)
                    .addComponent(trackingno, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel18)
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(typeofcargo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel15)
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel22)
                    .addComponent(comments, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        try{
            String sql = "INSERT INTO `tbl_cargo1`(`s_name`, `s_phone`, `s_email`, `s_address`, `r_name`, `r_phone`, `r_email`, `r_address`, `tracking#`, `typeofcargo`, `weight`, `depttime`, `origin`, `destination`, `pickupdate`, `pickuptime`, `comments`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/franz","root","");
            ...
            pst.setString(5, rname.getText());
            pst.setString(6, rphone.getText());
            pst.setString(7, remail.getText());
            pst.setString(8, raddress.getText());
            pst.setString(9, trackingno.getText());
            pst.setString(10, typeofcargo.getText());
            pst.setString(11, weight.getText());
            pst.setString(12, depttime.getText());
            pst.setString(13, origin.getText());
            pst.setString(14, destination.getText());
            pst.setString(15, pickupdate.getText());
            pst.setString(16, pickuptime.getText());
            pst.setString(17, comments.getText());
            pst.executeUpdate();
            JOptionPane.showMessageDialog(null, "Registered Success"); 
                  frmMainAdminn ma = new frmMainAdminn();
                  ma.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmAddNewCargo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmAddNewCargo().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JTextField depttime;
    ...
    public javax.swing.JTextField origin;
    public javax.swing.JTextField pickupdate;
    public javax.swing.JTextField pickuptime;
    public javax.swing.JTextField raddress;
    public javax.swing.JTextField remail;
    public javax.swing.JTextField rname;
    public javax.swing.JTextField rphone;
    public javax.swing.JTextField saddress;
    public javax.swing.JTextField semail;
    public javax.swing.JTextField sname;
    public javax.swing.JTextField sphone;
    private javax.swing.JButton submit;
    public javax.swing.JTextField trackingno;
    public javax.swing.JTextField typeofcargo;
